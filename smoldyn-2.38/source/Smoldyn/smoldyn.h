...
typedef struct surfacestruct {
	...
	Hashtable *pnametopanel[PSMAX];		// mapping of surface name to the corresponding panel pointer
...
typedef struct surfacesuperstruct {
	...
	Hashtable *snametosrf;						// mapping of surface name to the corresponding surface pointer
